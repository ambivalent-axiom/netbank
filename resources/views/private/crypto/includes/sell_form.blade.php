            ...
            <div class="mb-2 flex flex-col w-full p-2 bg-yellow-200 shadow sm:rounded-lg content-evenly flex-shrink-0">
                <div class="flex w-full flex-shrink-0">
                    ...
                    <div class="ml-3 mt-1 content-center">
                        <x-input-label>
                            {{ $portfolio->currency_name }}
                            <x-text-input
                                id="currency_name"
                                name="currency_name"
                                value="{{ $portfolio->currency_name }}"
                                required
                                hidden
                            >
                            </x-text-input>
                    ...
                    <div class="w-full flex flex-col content-center ml-5 mr-5 text-sm text-gray-700">
                        ...
                        <div class="flex justify-between">
                            <div>{{ __('Currently in posession: ') }}</div>
                            <div>
                                {{ number_format($portfolio->amount, 6) }}
                            </div>
                        </div>
                        <div class="flex justify-between">
                            <div>{{ __('In USD: ') }}</div>
                            <div>
                                {{ number_format($portfolio->profitUSD(), 2) }}
                            </div>
                        </div>
                    </div>
                </div>
